...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.train_img_dir = "images"
        self.val_img_dir = "images"
        self.test_img_dir = "images"
        # --------------- transform config ----------------- #
        # gray scale model
    ...
    def get_eval_dataset(self, **kwargs):
        ...
        # print(f'==============={self.data_dir}, {self.val_img_dir}')
        # print(f'==============={self.val_ann if not testdev else self.test_ann}')
        return COCODataset(
            data_dir=self.data_dir,
